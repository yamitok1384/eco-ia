...
\makeatother
\subtitle{Programa Formativo - Innovación Docente}
\author{}
\date{}
\begin{document}
...
\chapter{Proyecto Eco-IA:}\label{proyecto-eco-ia}

\subsubsection{Rediseño Metodológico
Transversal}\label{rediseuxf1o-metodoluxf3gico-transversal}

``Materialización del pensamiento crítico a través de entornos
interactivos y computación sostenible''

Diseño y Autoría: {Profesora Yamilka Toca Díaz}\\
\emph{Universidad de Zaragoza (UNIZAR) · IAF}

\section{Bienvenido al Ecosistema de
Aprendizaje}\label{bienvenido-al-ecosistema-de-aprendizaje}

\part{Información}

\chapter{Información General}\label{informaciuxf3n-general}

El proyecto \textbf{ECO-IA} nace como una respuesta educativa a la
necesidad de una alfabetización digital profunda, responsable y adaptada
a las demandas tecnológicas actuales. Este entorno ha sido diseñado bajo
los principios de la innovación docente, combinando el rigor académico
con una experiencia de usuario interactiva y amena.

\section{🎯 Los Tres Pilares
Metodológicos}\label{los-tres-pilares-metodoluxf3gicos}

Para transformar la experiencia de aprendizaje clásica en un proceso
inmersivo, el recurso se articula mediante tres ejes transversales:

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, breakable, colback=white, colframe=quarto-callout-note-color-frame, left=2mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, toprule=.15mm]

\vspace{-3mm}\textbf{🌐 1. Interactividad Real (IA Transparente)}\vspace{3mm}

A diferencia de los manuales estáticos, este entorno integra
laboratorios y simuladores dinámicos que permiten a estudiantes y
profesores ``abrir la caja negra'' de los algoritmos y comprender la
probabilidad matemática detrás de los modelos predictivos.
...
\vspace{-3mm}\textbf{🌿 2. Sostenibilidad Digital (Green AI)}\vspace{3mm}

Cada interacción con un modelo de lenguaje masivo tiene un coste
energético oculto. Promovemos la optimización del diseño de consultas
para maximizar la eficiencia y reducir de forma directa la huella de
carbono digital en los servidores de cómputo.
...
\vspace{-3mm}\textbf{🧠 3. Pensamiento Computacional Avanzado}\vspace{3mm}

Mediante la Ingeniería de Prompts basada en el método \textbf{R-T-C (Rol
- Tarea - Contexto)}, los alumnos adquieren habilidades de comunicación
humano-máquina críticas y estructuradas, mitigando el riesgo de
alucinaciones en los modelos generativos.

\end{tcolorbox}

\section{🛠️ Filosofía REA y Enfoque
Tecnológico}\label{filosofuxeda-rea-y-enfoque-tecnoluxf3gico}

Este entorno web es un \textbf{Recurso Educativo Abierto (REA)}
construido en su totalidad con \textbf{Quarto} y desplegado en la nube.
Esto garantiza ventajas críticas tanto para la comunidad docente como
para el alumnado:

\begin{itemize}
\tightlist
\item
  \textbf{Portabilidad Universal:} El material se adapta a cualquier
  dispositivo móvil, tablet o PC.
\item
  \textbf{Inclusión y Accesibilidad (DUA):} Compatible de forma nativa
  con lectores de pantalla y estructurado para reducir la carga
  cognitiva.
\item
  \textbf{Acceso Desconectado:} Dispone de un generador automático en la
  esquina superior derecha para descargar el itinerario completo en
  formato \textbf{PDF de alta calidad}.
\item
  \textbf{Código Abierto:} Al estar basado en texto plano
  (\texttt{.qmd}) y Git, es completamente modular, escalable y auditable
  por cualquier centro educativo de Aragón.
\end{itemize}

\subsection{👨‍🏫 Perfil del Alumnado}\label{perfil-del-alumnado}

Aunque el proyecto está diseñado principalmente para estudiantes de
\textbf{4º de ESO (Digitalización / Tecnología)} y \textbf{Módulos
transversales de Formación Profesional (Grados Medio y Superior)}, su
diseño escalable lo hace apto para cualquier plan de alfabetización
digital.

\section{📋 Estructura General del
Itinerario}\label{estructura-general-del-itinerario}

El programa formativo está dividido de forma secuencial en tres grandes
bloques y una sección de experimentación práctica:
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Módulo 1: Fundamentos} & Funcionamiento interno de modelos LLM,
pesos, sesgos y arquitectura predictiva. &
\texttt{Simulador\ Monty\ Hall} \\
\textbf{Módulo 2: Desafíos} & Ética algorítmica, sesgos de datos y el
impacto ambiental (\emph{Green AI}). &
\texttt{Calculadora\ de\ Tokens} \\
\textbf{Módulo 3: Aplicaciones} & Ingeniería de Prompts avanzada,
metodología R-T-C y casos de uso en FP. &
\texttt{Constructor\ de\ Prompts} \\
\textbf{Evaluación y Reto} & Proyecto de integración transversal y
pruebas de asimilación conceptual. & \texttt{Proyecto\ Final\ ECO-IA} \\
\end{longtable}
}

\chapter{Calendario}\label{calendario}

A continuación se detalla la planificación temporal, la carga horaria y
la distribución de los bloques formativos del proyecto \textbf{ECO-IA}.
Esta estructura modular garantiza un avance progresivo, permitiendo
compaginar la teoría conceptual con los laboratorios interactivos en el
navegador.

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{⏳ Duración Total del Programa}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

El curso consta de una carga lectiva total de \textbf{60 horas},
distribuidas estratégicamente a lo largo de 4 semanas de aprendizaje
inmersivo.

\end{tcolorbox}

\section{📅 Itinerario Temporal y Carga
Horaria}\label{itinerario-temporal-y-carga-horaria}

\subsection{📐 Vista de Bloques (Semana a Semana)}

\subsubsection{🔹 Semana 1: Módulo 1 · Fundamentos de la IA (10
Horas)}\label{semana-1-muxf3dulo-1-fundamentos-de-la-ia-10-horas}

\begin{itemize}
\tightlist
\item
  \textbf{Contenidos:} Funcionamiento interno de modelos LLM, pesos,
  sesgos y arquitectura predictiva.
\item
  \textbf{Hito Práctico:} Desmitificación de la ``Caja Negra'' mediante
  el simulador interactivo de Monty Hall.
\item
  \textbf{Dedicación:} 2 horas diarias de experimentación interactiva.
\end{itemize}

\subsubsection{🔹 Semanas 2 y 3: Módulo 2 · Avances y Desafíos (30
Horas)}\label{semanas-2-y-3-muxf3dulo-2-avances-y-desafuxedos-30-horas}

\begin{itemize}
\tightlist
\item
  \textbf{Contenidos:} Ética algorítmica, sesgos de datos e impacto
  medioambiental masivo (\emph{Green AI}).
\item
  \textbf{Hito Práctico:} Auditoría energética de consultas mediante la
  Calculadora de Tokens integrada en el ecosistema.
\item
  \textbf{Dedicación:} Bloque de alta carga conceptual y de análisis
  crítico.
\end{itemize}

\subsubsection{🔹 Semana 4: Módulo 3 · Ingeniería de Prompts Avanzada
(20
Horas)}\label{semana-4-muxf3dulo-3-ingenieruxeda-de-prompts-avanzada-20-horas}

\begin{itemize}
\tightlist
\item
  \textbf{Contenidos:} Diseño avanzado de instrucciones, el método
  \textbf{R-T-C (Rol-Tarea-Contexto)} y mitigación de alucinaciones en
  entornos profesionales.
\item
  \textbf{Hito Práctico:} Despliegue del Constructor de Prompts
  Eficientes y entrega del Proyecto Final ECO-IA.
\end{itemize}

\subsection{📊 Tabla de Especificación Académica}

Si prefieres una organización matricial clásica de la dedicación
horaria, consulta los pesos del programa en la siguiente tabla:
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Módulo 1} & Fundamentos y Redes Predictivas & Simulador Monty
Hall & \textbf{10 horas} \\
\textbf{Módulo 2} & Sesgos, Ética y Huella de Carbono (\emph{Green AI})
& Calculadora de Tokens & \textbf{30 horas} \\
\textbf{Módulo 3} & Ingeniería de Prompts (Método R-T-C) & Constructor
de Prompts & \textbf{20 horas} \\
\textbf{Cierre} & Integración del Portafolio de Evidencias & Reto Final
de Aplicación & \emph{Evaluación Continua} \\
\end{longtable}
}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, breakable, colback=white, colframe=quarto-callout-tip-color-frame, left=2mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, toprule=.15mm]

\vspace{-3mm}\textbf{📢 Recomendación para el Alumnado}\vspace{3mm}

Las fechas exactas y los plazos de entrega se sincronizan de manera
flexible según las necesidades de cada centro educativo de la Comunidad
Autónoma de Aragón. Te recomendamos revisar de forma periódica las
alertas de la barra superior.
...
\section{¿Qué es la Inteligencia
...
\section{Principales hitos en la evolución de la IA
(1950--2024)}\label{principales-hitos-en-la-evoluciuxf3n-de-la-ia-19502024}

\protect\phantomsection\label{timeline}

\,Si se me ocurre algo para colocar aqui lo pongo o lo borro
...
Una neurona artificial es una unidad de cálculo que procesa información
siguiendo estos pasos lógicos:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Entradas (x):} Recibe un vector de datos provenientes del
  exterior o de otras neuronas.
\item
  \textbf{Pesos (w):} Cada entrada tiene un peso asociado que indica su
  importancia relativa en el proceso de decisión.
\item
  \textbf{Regla de Propagación:} El sistema multiplica cada entrada por
  su peso, suma todos los resultados y añade un \textbf{sesgo (b)} para
  ajustar la sensibilidad del modelo.
\item
  \textbf{Función de Activación (f):} El resultado final se pasa por una
  función que decide si la neurona se ``excita'' (genera una salida
  activa) o permanece inactiva. Este resultado final es lo que conocemos
  como \textbf{activación}.
\end{enumerate}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsubsection{¿Cómo funciona este proceso? De la Biología al
Algoritmo}\label{cuxf3mo-funciona-este-proceso-de-la-biologuxeda-al-algoritmo}

Para entender la IA, primero debemos mirar a la naturaleza. Las redes
neuronales artificiales son una inspiración matemática de nuestro propio
cerebro:
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Dendritas} & \textbf{Entradas (\(x\))} & Reciben los datos del
exterior (ej. los píxeles de una imagen). \\
\textbf{Sinapsis} & \textbf{Pesos (\(w\))} & Fuerza o importancia de la
conexión. Es lo que la red ``aprende''. \\
\textbf{Soma (Núcleo)} & \textbf{Suma + Sesgo (\(b\))} & Procesa la
información acumulada. \\
\textbf{Axón} & \textbf{Activación (Salida)} & Transmite la decisión o
predicción final. \\
\end{longtable}
}
...
\subsection{🔬 Laboratorio: Entrenamiento
vs.~Inferencia}\label{laboratorio-entrenamiento-vs.-inferencia}

En la programación tradicional, nosotros escribimos las reglas. En la
IA, \textbf{la máquina descubre las reglas ajustando sus pesos}. Vamos a
simular las dos fases críticas de este proceso.

\section{🧠 Entrena tu primera neurona
IA}\label{entrena-tu-primera-neurona-ia}

\protect\phantomsection\label{ai-neural-lab}

Durante el entrenamiento, la red neuronal analiza miles de píxeles y
...
\protect\phantomsection\label{neural-lab-v3}

\section{🧠 Entrena una IA para reconocer gatos y
perros}\label{entrena-una-ia-para-reconocer-gatos-y-perros}

\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, coltitle=black, left=2mm, leftrule=.75mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{¿Qué está ocurriendo aquí?}, titlerule=0mm, toprule=.15mm, toptitle=1mm]

La IA NO ``ve'' animales como los humanos.

Durante el entrenamiento: - recibe ejemplos, - calcula errores, - ajusta
pesos, - y aprende patrones matemáticos.

Después, durante la inferencia, intenta reconocer nuevas imágenes usando
lo aprendido.

\end{tcolorbox}

\protect\phantomsection\label{ai-lab}

\protect\phantomsection\label{neurona-demo}
...
ejemplos}. No se le dictan reglas fijas; el sistema ajusta
automáticamente sus \textbf{pesos (\(w\))} hasta que sus predicciones
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{modulo1/../img/neurona_bio.png}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{modulo1/../img/neurona_art.png}}
...
\subsubsection{¿Cómo funciona este
proceso?}\label{cuxf3mo-funciona-este-proceso-1}
